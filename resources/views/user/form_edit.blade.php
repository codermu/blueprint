        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Data<small>Click to validate</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form" method="post" action="{{url('/edit-data')}}" data-parsley-validate>
                      {{csrf_field()}}
                      <input type="hidden" name="id" value="{{$siswa->id}}">
                      <label for="fullname">Full Name * :</label>
                      <input type="text" id="fullname" class="form-control" name="nama" value="{{$siswa->nama}}" required />

                      <label for="email">Alamat * :</label>
                      <input type="email" id="email" class="form-control" name="alamat" value="{{$siswa->alamat}}" data-parsley-trigger="change" required />
					
					  <label for="email">Kelas * :</label>
                      <input type="email" id="email" class="form-control" name="kelas" value="{{$siswa->kelas}}" data-parsley-trigger="change" required />	
